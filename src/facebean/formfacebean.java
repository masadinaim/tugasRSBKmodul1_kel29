 ...
 * @author Masadi
 */
public class formfacebean extends javax.swing.JFrame {

    /**
     * Creates new form formfacebean
     */
    public formfacebean() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formfacebean.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formfacebean().setVisible(true);
            }
        });
    }
